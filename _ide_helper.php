...
namespace Illuminate\Support\Facades {
    ...
    class Gate {
        ...
        /**
         * Register a callback to run before all Portal checks.
         *
         * @param callable $callback
         * @return $this
         * @static
        ...
        /**
         * Register a callback to run after all Portal checks.
         *
         * @param callable $callback
         * @return $this
         * @static
    ...
    class Request {
         ...
         *
         * It works if your JavaScript library sets an X-Requested-EagerLoad HTTP header.
